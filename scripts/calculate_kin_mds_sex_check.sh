...
--geno 0.05 \
--make-bed \
--out ${outD}G77318RH_QC1

## Prune the data ##
/home/unix/aganna/plink_linux_x86_64/plink -bfile ${outD}G77318RH_QC1 \
--indep-pairwise 100 50 0.2 \
--out ${outD}G77318RH_QC1

## Keep only pruned data ##
/home/unix/aganna/plink_linux_x86_64/plink -bfile ${outD}G77318RH_QC1 \
--extract ${outD}G77318RH_QC1.prune.in \
--make-bed \
--out ${outD}G77318RH_QC1_pruned


## Run IBD ##
king -b ${outD}G77318RH_QC1_pruned.bed --kinship --prefix ${outD}G77318RH_QC1_pruned

## Run MDS ##
king -b ${outD}G77318RH_QC1_pruned.bed --mds --prefix ${outD}G77318RH_QC1_pruned
